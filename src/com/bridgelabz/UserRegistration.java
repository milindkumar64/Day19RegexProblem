...
public class UserRegistration {
	...
	public static void main(String[] args) {
		...
		Pattern emailPattern = Pattern.compile("^[a-z]{3}(\\-|\\.|\\+|100|111)*[@](1|\\.)?[a-z]{3,5}([\\.][a-z]{2,3}){1,2}$");
...
//[\\.]([a-z]{3,5})?
		 ...
		 * 
		 * System.out.
		 * println("Enter Password must contain 8 char with atleast one Upper case: ");
		 * String pass = sc.next(); Pattern passPattern =
		 * Pattern.compile("^(?=.*\\W)(?=.*[A-Z])(?=.*\\d).{8,}$"); Matcher passMatcher
		 * = passPattern.matcher(pass); if (passMatcher.matches() == false)
